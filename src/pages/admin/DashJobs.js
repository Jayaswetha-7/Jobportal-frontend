...
const DashJobs = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            headerName: 'Category',
            width: 150,
            valueGetter: (value, row) => row?.jobType?.jobTypeName || "N/A"
        },
        {
            field: 'user',
            headerName: 'User',
            width: 150,
            valueGetter: (value, row) => row?.user?.firstName || "N/A"
        },
        {
            field: 'available',
...

        {
            ...
            width: 200,
            renderCell: (values) => (
                <Box sx={{ display: "flex", justifyContent: "space-between", width: "170px", marginTop:"6px" }}>
