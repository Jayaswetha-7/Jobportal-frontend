                ...
                <Box sx={{ display: "flex", justifyContent: "space-between", flexDirection: "column", height: "100%" }}>
                    <Box>
                        <Box sx={{ pt: 3, pb: 5, display: "flex", justifyContent: "center" }}>
                            ...
                            {
                                collapsed ?
                                    <Avatar alt="logo dashboard" src='https://images.pexels.com/photos/1130626/pexels-photo-1130626.jpeg' /> :
                                    <Box sx={{ display: "flex", justifyContent: "center" }}>
                                        <img style={{ width: "100px", heigth: "100px", textAlign: "center", transition: "all ease-out .5s" }} src='https://images.pexels.com/photos/1130626/pexels-photo-1130626.jpeg' alt="logo dashboard" />
                                    </Box>
                            }
